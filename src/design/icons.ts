...
export const ICON_PATHS: Record<IconName, string> = {
  ...
  graph:
    "M7 16c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm10 0c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zM12 4c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm0 5.5c-.4 0-.7.1-1 .2L8.3 13c.4.4.7.9.7 1.5 0 .2 0 .3-.1.5l2.4-1.5c.2.1.4.1.7.1s.5 0 .7-.1l2.4 1.5c0-.2-.1-.3-.1-.5 0-.6.3-1.1.7-1.5L13 9.7c-.3-.1-.6-.2-1-.2z",
};
